...
class CategoryinfoController {
  ...
  async update(ctx, next) {
    const { id } = ctx.params;
    const { name, newPrice, oldPrice, picture, status, count, nameDesc, weight } = ctx.request.body;
    const data = { id, name, newPrice, oldPrice, picture, status, count, nameDesc, weight };
